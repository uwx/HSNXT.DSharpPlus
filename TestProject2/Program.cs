...
namespace TestProject2
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return str == "" ? "" : HttpUtility.HtmlEncode(str);
        }
        ...
        {
            return str == "" ? "" : HttpUtility.HtmlDecode(str);
        }
        ...
        public static int ToInteger(this string strToConvert)
        {
            ...
            {
                throw new Exception("str could not be converted to Integer");
            }
        }
        ...
        public static DateTime ToDateTime(this string str)
        {
            ...
            {
                throw new Exception("Object cannot be converted to DateTime. Object: " + str);
            }
        }
