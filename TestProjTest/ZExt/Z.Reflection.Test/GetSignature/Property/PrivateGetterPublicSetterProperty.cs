...
namespace HSNXT.Z.Reflection.Test
{
    ...
    public class Property_GetSignature_PrivateGetterPublicSetterProperty
    {
        ...
        {
            // Type
            var @this = typeof(PropertyModel<int>).GetProperty("PrivateGetterPublicSetterProperty", BindingFlags.Static | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
