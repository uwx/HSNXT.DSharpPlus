...
namespace HSNXT.Z.Reflection.Test
{
    ...
    public class Property_GetSignature_AbstractProperty
    {
        ...
        {
            // Type
            var @this = typeof(AbstractPropertyModel).GetProperty("AbstractProperty", BindingFlags.Static | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
