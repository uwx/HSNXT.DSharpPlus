...
namespace HSNXT.Z.Reflection.Test
{
    ...
    public class Property_GetSignature_ProtectedInternalProperty
    {
        ...
        {
            // Type
            var @this = typeof(PropertyModel<int>).GetProperty("ProtectedInternalProperty", BindingFlags.Static | BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
