namespace HSNXT
{
    ...
    /// </summary>
    internal static class DigitOpHelper
    {
        ...
        public static unsafe uint Add(uint[] digits1, uint length1, uint[] digits2, uint length2, uint[] digitsRes)
        {
        ...
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint Add(uint* digitsPtr1, uint length1, uint* digitsPtr2, uint length2,
            uint* digitsResPtr)
        {
            ulong c = 0;
            ...
            if (length1 < length2)
            {
                ...
                var lengthTemp = length1;
                length1 = length2;
                length2 = lengthTemp;

                var ptrTemp = digitsPtr1;
        ...
        /// <param name="digitsRes">Resulting big integer digits.</param>
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint Sub(uint[] digits1, uint length1, uint[] digits2, uint length2, uint[] digitsRes)
        {
            fixed (uint* digitsPtr1 = digits1, digitsPtr2 = digits2, digitsResPtr = digitsRes)
            {
        ...
        /// <param name="digitsResPtr">Resulting big integer digits.</param>
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint Sub(uint* digitsPtr1, uint length1, uint* digitsPtr2, uint length2,
            uint* digitsResPtr)
        {
            ulong c = 0;
        ...
        public static unsafe uint DivMod(uint[] digits1, uint length1, uint int2, uint[] divRes, out uint modRes)
        {
        ...
        /// <param name="modRes">Remainder (always filled).</param>
        /// <returns>Result length (0 if result is null).</returns>
        public static unsafe uint DivMod(uint* digitsPtr1, uint length1, uint int2, uint* divResPtr, out uint modRes)
        {
            ulong c = 0;
            uint res;
            for (var index = length1 - 1; index < length1; --index)
            {
        ...
        public static unsafe uint Mod(uint[] digits1, uint length1, uint int2)
        {
        ...
        /// <param name="int2">Second integer.</param>
        /// <returns>Remainder.</returns>
        public static unsafe uint Mod(uint* digitsPtr1, uint length1, uint int2)
        {
            ulong c = 0;
            uint res;
            for (var ptr1 = digitsPtr1 + length1 - 1; ptr1 >= digitsPtr1; --ptr1)
            {
        ...
        public static unsafe int Cmp(uint[] digits1, uint length1, uint[] digits2, uint length2)
        {
        ...
        /// <param name="length2">Second big integer length.</param>
        /// <returns>Comparsion result.</returns>
        public static unsafe int Cmp(uint* digitsPtr1, uint length1, uint* digitsPtr2, uint length2)
        {
            // Maybe length comparing will be enough
            var res = CmpLen(length1, length2);
            if (res != -2) return res;
        ...
        /// <param name="length2">Second big integer length.</param>
        /// <returns>Comparsion result.</returns>
        private static int CmpLen(uint length1, uint length2)
        {
        ...
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint Shr(uint* digitsPtr, uint length, uint* digitsResPtr, int rightShift,
            bool resHasOffset)
        {
            var rightShiftRev = Constants.DigitBitCount - rightShift;
            ...
            else
            {
                ...
                var digitsPtrEndPrev = digitsPtr + length - 1;
                var digitsPtrNext = digitsPtr + 1;
                ...
                var lastValue = *digitsPtr >> rightShift;
                if (lastValue != 0)
                {
        ...
        /// <param name="length2">Second big integer length.</param>
        /// <param name="digitsRes">Resulting big integer digits.</param>
        public static unsafe void BitwiseOr(uint[] digits1, uint length1, uint[] digits2, uint length2,
            uint[] digitsRes)
        {
            fixed (uint* digitsPtr1 = digits1, digitsPtr2 = digits2, digitsResPtr = digitsRes)
            {
        ...
        /// <param name="digitsRes">Resulting big integer digits.</param>
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint BitwiseAnd(uint[] digits1, uint[] digits2, uint length, uint[] digitsRes)
        {
            fixed (uint* digitsPtr1 = digits1, digitsPtr2 = digits2, digitsResPtr = digitsRes)
            {
        ...
        /// <param name="digitsRes">Resulting big integer digits.</param>
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint ExclusiveOr(uint[] digits1, uint length1, uint[] digits2, uint length2,
            uint[] digitsRes)
        {
            fixed (uint* digitsPtr1 = digits1, digitsPtr2 = digits2, digitsResPtr = digitsRes)
            {
        ...
        /// <param name="digitsRes">Resulting big integer digits.</param>
        /// <returns>Resulting big integer length.</returns>
        public static unsafe uint OnesComplement(uint[] digits, uint length, uint[] digitsRes)
        {
            fixed (uint* digitsPtr = digits, digitsResPtr = digitsRes)
            {
                for (uint i = 0; i < length; i++)
