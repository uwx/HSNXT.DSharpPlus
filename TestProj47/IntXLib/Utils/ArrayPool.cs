...
namespace HSNXT
{
    ...
    internal sealed class ArrayPool<T>
    {
        ...
        /// Singleton instance.
        /// </summary>
        public static readonly ArrayPool<T> Instance = new ArrayPool<T>(
        ...
        private readonly int _minPooledArraySizeLog2;

        private readonly int _maxPooledArraySizeLog2;

        // Maximal pool items count
        private int _maxPoolCount;

        private Stack<WeakReference>[] _pools; // ArrayPool pools
        ...
        {
            var lengthLog2 = Bits.Msb((uint) array.LongLength);
