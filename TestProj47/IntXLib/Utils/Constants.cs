...
namespace HSNXT
{
    ...
    internal static class Constants
    {
        ...
        static Constants()
        {
            ...
            for (var i = 10; i < BaseLowerChars.Length; i++)
            {
        ...
        /// </summary>
        public static readonly IDictionary<char, uint> BaseCharToDigits;
        ...
        /// </summary>
        public static readonly double DigitBaseLog = Math.Log(1UL << DigitBitCount);
