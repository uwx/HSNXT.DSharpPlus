namespace HSNXT
{
    ...
    /// </summary>
    internal sealed class ClassicDivider : DividerBase
    {
        /// <summary>
            ...
            int cmpResult)
        {
            ...
            fixed (uint* digitsPtr1 = digits1, digitsBufferPtr1 = digitsBuffer1, digitsPtr2 =
                digits2, digitsBufferPtr2 = digitsBuffer2, digitsResPtr = digitsRes != null ? digitsRes : digits1)
            {
                return DivMod(
                    digitsPtr1,
                    digitsBufferPtr1,
            ...
            int cmpResult)
        {
            ...
            var shift1 = 31 - Bits.Msb(digitsPtr2[length2 - 1]);
            if (shift1 == 0)
            {
            ...
            {
                var rightShift1 = Constants.DigitBitCount - shift1;
            ...
            var lastDigit2 = digitsBufferPtr2[length2 - 1];
            var preLastDigit2 = digitsBufferPtr2[length2 - 2];
            ...
            for (uint i = maxLength, iLen2 = length1, j, ji; i <= maxLength; --i, --iLen2)
            {
                ...
                {
                    longDigit = (ulong) digitsBufferPtr1[iLen2] << Constants.DigitBitCount |
                                digitsBufferPtr1[iLen2 - 1];
                }
                ...
                for (;;)
                {
                    if (divEst == Constants.BitCountStepOf2 || divEst * preLastDigit2 >
                        (modEst << Constants.DigitBitCount) + digitsBufferPtr1[iLen2 - 2])
                    {
                        --divEst;
                        modEst += lastDigit2;
