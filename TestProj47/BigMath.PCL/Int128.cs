...
namespace HSNXT
{
    ...
    {
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] [FieldOffset(0)] private ulong _lo;
        [DebuggerBrowsable(DebuggerBrowsableState.Never)] [FieldOffset(8)] private ulong _hi;
