...
namespace DevLib.ExtensionMethods
{
  ...
  public static class ReflectionExtensions
  {
    ...
    {
      if (source.Equals(baseType) || (source.AssemblyQualifiedName != null || baseType.AssemblyQualifiedName != null) && source.AssemblyQualifiedName == baseType.AssemblyQualifiedName)
        return true;
    ...
    {
      return Type.GetTypeCode(source) != TypeCode.Object || source.IsEnum || (source == typeof (Guid) || source == typeof (TimeSpan)) || (source == typeof (DateTimeOffset) || source.IsNullableCanConvert());
    }
    ...
    {
      return source.GetType().GetProperty(propertyName, isPublicOnly ? BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).GetValue(source, index);
    }
    ...
    {
      return source.GetType().MakeGenericType(typeArguments).GetProperty(propertyName, isPublicOnly ? BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).GetValue(source, index);
    }
    ...
    {
      source.GetType().GetProperty(propertyName, isPublicOnly ? BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).SetValue(source, value, index);
      return source;
    }
    ...
    {
      source.GetType().MakeGenericType(typeArguments).GetProperty(propertyName, isPublicOnly ? BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic).SetValue(source, value, index);
      return source;
    }
