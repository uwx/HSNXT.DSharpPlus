...
namespace TestProj47
{
    ...
    public static string Capitalize(this string value)
    {
      if (string.IsNullOrWhiteSpace(value))
        return value;
      return Extensions.regexCapitalize.Replace(value, (MatchEvaluator) (m => m.Groups[1].Value.ToUpperInvariant()));
    }
    ...
    {
      return format.FormatNamed((IFormatProvider) null, args).ToString();
    }
    ...
    public static string TrimEnd(this string s, string trimString, bool caseSensitive = true)
    {
      ...
      {
        if ((caseSensitive ? ((int) trimString[trimString.Length - num] != (int) s[s.Length - num] ? 1 : 0) : ((int) char.ToLowerInvariant(trimString[trimString.Length - num]) != (int) char.ToLowerInvariant(s[s.Length - num]) ? 1 : 0)) != 0)
          return s;
      }
    ...
    {
      return Extensions.toLinkRegex.Replace(text, (MatchEvaluator) (match =>
      {
    ...
    public static string TrimStart(this string s, string trimString, bool caseSensitive = true)
    {
      ...
      {
        if ((caseSensitive ? ((int) trimString[startIndex] != (int) s[startIndex] ? 1 : 0) : ((int) char.ToLowerInvariant(trimString[startIndex]) != (int) char.ToLowerInvariant(s[startIndex]) ? 1 : 0)) != 0)
          return s;
      }
      ...
      while (true)
      {
        ...
        do
        {
          if (index2 < length)
          {
            ...
            if ((int) ch1 == 125)
            {
              if (index2 < length && (int) format[index2] == 125)
                ++index2;
              else
                Extensions.ThrowInvalidFormatException();
            }
            if ((int) ch1 == 123)
            {
              if (index2 >= length || (int) format[index2] != 123)
                --index2;
              else
                goto label_10;
            }
          ...
          while ((int) ch2 >= 48 && (int) ch2 <= 57 || (int) ch2 >= 65 && (int) ch2 <= 122 && index1 < 1000000);
          if (index1 >= args.Length)
            Extensions.ThrowOutOfRangeException();
          while (index3 < length && (int) (ch2 = format[index3]) == 32)
            ++index3;
          flag = false;
          var num = 0;
          if ((int) ch2 == 44)
          {
            ++index3;
            while (index3 < length && (int) format[index3] == 32)
              ++index3;
            if (index3 == length)
              Extensions.ThrowInvalidFormatException();
            ch2 = format[index3];
            ...
            while ((int) ch2 >= 48 && (int) ch2 <= 57 && num < 1000000);
          }
          while (index3 < length && (int) (ch2 = format[index3]) == 32)
            ++index3;
          var obj = args[index1];
          ...
          if ((int) ch2 == 58)
          {
            ...
            while (true)
            {
              ...
              else if (index4 < length && (int) format[index4] == 123)
                ++index4;
              else
                Extensions.ThrowInvalidFormatException();
...
label_76:
    ...
    {
      throw new FormatException("The number of named parameters {..} must be less than or equal to the arguments.");
    }
